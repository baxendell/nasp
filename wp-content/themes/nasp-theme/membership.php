		...
		<div class="row no-gutters membership-section">
			...
			<div class="col">
				...
				<div class="list-group" id="myList" role="tablist">
					<a class="list-group-item list-group-item-action active" data-toggle="list" href="#gold" role="tab">Gold Membership</a>
					<a class="list-group-item list-group-item-action" data-toggle="list" href="#gold-corp" role="tab">Gold Corporate</a>
					<a class="list-group-item list-group-item-action" data-toggle="list" href="#silver" role="tab">Silver Membership</a>
